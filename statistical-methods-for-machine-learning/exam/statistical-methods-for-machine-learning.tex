...
$$
\Upsilon(\pi) := \sum_{\mu \in E} w^{-K(\mu)} V_{\mu}^{\pi}
$$

\newpage
\input{chapters/1_introduction.tex}
\input{chapters/2_nearest_neighbour.tex}
\input{chapters/3_tree_predictors.tex}
\input{chapters/4_statistical_learning.tex}
\input{chapters/5_risk_analisys_for_tree_predictors.tex}
\input{chapters/6_hyperparameter_tuning_and_risk_estimates.tex}
\input{chapters/7_consistency_and_nonparametric_algorithms.tex}
\input{chapters/8_risk_analysis_for_nearest_neighbot.tex}
\input{chapters/9_linear_predictors.tex}
\input{chapters/10_online_gradient_descent.tex}
\input{chapters/11_kernel_functions.tex}
\input{chapters/12_support_vector_machine.tex}
\input{chapters/13_stability_and_risk_control_for_SVM.tex}
\input{chapters/14_neural_networks_and_deep_learning.tex}
\input{chapters/15_logistic_regression_surrogate_losses.tex}
% \input{chapters/copilot-questions.tex}
